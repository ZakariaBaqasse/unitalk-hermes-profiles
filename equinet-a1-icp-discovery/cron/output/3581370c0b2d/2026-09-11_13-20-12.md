...
**Equinet discovery run completed and staged for human review.**

- **Ticket / application run:** `A1-20260911124516-B16386`
- **n8n execution:** `1350` — succeeded; compact result retrieved once.
- **Scope:** Horse Owner prospects, Louisville, Kentucky, United States.
- **Routing:** 4 returned leads
  - No website candidate: **1**
  - Website candidates: **3**

**Website-lane outcome**
- Deterministically scored: **2**
- Evidence-backed out of scope: **1**
- Enrichment fallback / sync failure: **0**

**Twenty staging**
- Company terminal dispositions: **4 / 4**
- Verified Company IDs/read-backs: **4**
- Linked People expected: **0**
- Possible matches: **0**
- Sync failures: **0**
- Missing Company names: **0**
- Only Company records were staged; no outreach, A2 invocation, HubSpot write, Opportunity, Task, campaign, or message action occurred.

**Final verified combined index:**  
`/opt/data/profiles/equinet-a1-icp-discovery/runtime/n8n-poll-tickets/A1-20260911124516-B16386-two-lane-v1/final-staging-index.json`

**Limitations / review boundary**
- HubSpot screening remained the n8n-provided, read-only company-domain screen. One no-domain candidate retained its `not_checked_no_lookup_key` limitation and requires review.
- One website-verified organisation was classified evidence-backed **out of scope**.
- All staged Companies remain pending mandatory human review; no candidate has been approved for A2 or outreach.
