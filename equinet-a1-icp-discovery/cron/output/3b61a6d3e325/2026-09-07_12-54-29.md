...
Staging is blocked and requires operator repair.

- **Run:** `A1-20260907120705-GHYRIP`
- **Ticket:** `execution-1282`
- **Phase:** `stage_no_website`
- **Routing completed:** 30 leads — 28 no-website, 2 website-candidate.
- **Blocker:** Twenty’s linked-Person duplicate-preflight Company filter returned **HTTP 400**. Company fingerprint, domain, and name filters were usable, but the required People-by-Company filter was not.
- **Write boundary:** No Twenty Company or Person write was attempted. n8n was not rerun and its result was not retrieved again.
- **Artifacts:**
  - `runtime/n8n-poll-tickets/two-lane-v1-execution-1282/operator-repair-twenty-capability.json`
  - `runtime/n8n-poll-tickets/two-lane-v1-execution-1282/twenty-capability-failure.json`

Required repair: fix and regression-test the deterministic Twenty People company-filter query contract, then perform a separately controlled staging recovery from the immutable discovery result.
