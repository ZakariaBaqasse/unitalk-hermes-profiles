...
**Equinet n8n discovery run failed before producing a final discovery result.**

- Application run: `1a9a7159-86b2-4b03-8cf0-b9d0d5b2f332`
- Workflow: `C5J61bWDUEf5X8ab`
- n8n execution: `777`
- Observed execution status: `error`
- Ticket: `cc037635-0766-4c8f-a427-61eb5cea732d`
- Poll count: `1`
- Delivery recorded: `local-cron-output`

No final-node data was retrieved, so no enrichment, qualification, confidence calculation, ICP scoring, candidate validation, review package, HubSpot screening result, or Twenty action occurred.

The ticket is marked failed and delivered. Human review is required to inspect the n8n execution error before any authorised restart; this cron monitor did not rerun the workflow.
