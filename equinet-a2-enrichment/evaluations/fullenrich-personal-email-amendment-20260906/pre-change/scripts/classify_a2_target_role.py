#!/usr/bin/env python3
"""Classify an Equinet A2 current role using the confirmed 0.2.0 role model."""
...
DEFAULT_CATALOGUE = ROOT / "foundations/contracts/business/a2-business-field-catalogue-0.3.0.json"
...
ALIASES = {
    "farrier": {
        "primary": {
            ...
            "professional_farrier": ["professional farrier"],
        },
        "secondary": {
...
CONDITIONS = {
    "business_office_practice_manager_with_commercial_responsibility": "commercial_or_purchasing_responsibility",
    "operations_manager_with_horse_care_or_purchasing_responsibility": "horse_care_or_purchasing_responsibility",
    "assistant_manager_operations_coordinator_with_purchasing_responsibility": "purchasing_responsibility",
    "farrier_instructor_educator_without_current_commercial_activity": "no_current_commercial_or_professional_farrier_activity",
    "retired_inactive_farrier_without_current_professional_activity": "no_current_professional_activity",
}
...
def main() -> int:
    ...
    if catalogue.get("version") != "0.2.0":
        print(json.dumps({"status": "invalid", "error": "active catalogue 0.2.0 is required"}, indent=2))
        return 1
