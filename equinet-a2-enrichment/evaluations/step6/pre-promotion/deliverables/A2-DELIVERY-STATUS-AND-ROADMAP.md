...
**Version:** `1.2.6`  
**Updated:** `2026-08-29T20:23:18Z`  
**Profile:** `equinet-a2-enrichment`  
**Current status:** `FOUNDATION CONFIGURED — NOT PILOT-READY`  
**Next delivery gate:** `Step 6 — live gateway smoke test and configuration approval`
...
### Step 6 — Model, Tools, Permissions and Quotas — CONFIGURED / STATIC VALIDATION PASS / LIVE GATEWAY SMOKE PENDING
...
Run a real primary-model smoke test from a session launched with `equinet-a2-enrichment`, then run a controlled fallback-route test. After both receipts are recorded, present **S6-1 through S6-10** for promotion.
