...
REGISTER = ROOT / "foundations/contracts/sources/a2-source-register-0.3.1.json"
CATALOGUE = ROOT / "foundations/contracts/business/a2-business-field-catalogue-0.3.1.json"
PROVIDERS = ROOT / "foundations/contracts/governance/a2-provider-and-cost-policy-0.3.1.json"
...
FULLENRICH_CONTACT_FIELDS = {"person.business_email", "person.mobile_phone", "person.personal_email_candidate"}
...
def preflight(request: dict[str, Any], register: dict[str, Any], catalogue: dict[str, Any], providers: dict[str, Any]) -> dict[str, Any]:
    ...
    if source:
        ...
        if source_id == "fullenrich_contact_enrichment":
            ...
            if field_key=*** "person.personal_email_candidate" and request.get("incidental_provider_output") is not True:
                blocks.append("personal_email_must_be_incidental_not_requested")
