...
- Business Field Catalogue `0.2.0`, implementing Equinet-confirmed target roles, contact selection and Horse Owner priorities.
- Minimum Data Packages `0.2.0`, implementing Equinet-confirmed contact, location, horse-count and breed requirements.
- A2 Source Register `0.2.0`, business scope confirmed; runtime activation pending.
- Evidence, Verification, Confidence and Freshness Policy `0.2.0`, refreshed for the Equinet-confirmed business configuration; remaining freshness confirmations stay open.
- Protected Fields and Conflict Policy `0.2.0`, refreshed for `owner_horse_count` authority and guarded-write handling.
- Provider and Cost Policy `0.2.0`, business scope confirmed; runtime activation pending.
- Preliminary A2-to-HubSpot Mapping `0.2.0`, Equinet-confirmed business semantics; live verification pending.
...
- No-Integration Runtime Policy `1.1.0`, approved for the Equinet business-confirmation release with no external business action.
