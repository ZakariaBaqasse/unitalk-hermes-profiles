...
HubSpot remains Equinet's final CRM system of record. The machine-readable mapping at `foundations/contracts/mappings/a2-hubspot-preliminary-mapping-0.2.0.json` is authoritative. All mappings remain read-and-propose only until live metadata, permissions, workflow dependencies and guarded-write controls are verified.
