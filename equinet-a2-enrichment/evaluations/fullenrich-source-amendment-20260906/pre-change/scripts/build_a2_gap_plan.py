...
PACKAGES = ROOT / "foundations/contracts/business/a2-minimum-data-packages-0.2.0.json"
SOURCES = ROOT / "foundations/contracts/sources/a2-source-register-0.2.0.json"
...
EMAIL_FIELDS = {"person.business_email"}
...
def source_candidates(field_key: str, source_index: dict[str, dict[str, Any]]) -> list[dict[str, Any]]:
    candidates: list[str] = [
        "a1_approved_handoff",
        "a1_directory_evidence_reuse",
        "hubspot_authoritative_records",
...
def analyse(request: dict[str, Any], catalogue: dict[str, Any], packages: dict[str, Any], sources: dict[str, Any]) -> dict[str, Any]:
    ...
    for key, (priority, alternatives) in dedup.items():
        ...
        item = {
            ...
            "need_type": need_type,
            "source_candidates": source_candidates(key, source_index),
