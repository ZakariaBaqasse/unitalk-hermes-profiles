...
def main():
 ...
 snapshot=gap_request;p=write('minimum-package',snapshot);min_out=a.output_dir/'minimum-package.json';run('a2-evaluate-minimum-package',['scripts/evaluate_a2_minimum_package.py',str(p),'--packages','foundations/contracts/business/a2-minimum-data-packages-0.2.0.json','--output',str(min_out)])
