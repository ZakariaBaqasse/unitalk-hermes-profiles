...
CAT_REL='foundations/contracts/business/a2-business-field-catalogue-0.1.1-draft.1.json';CAT=ROOT/CAT_REL

def finalise(previous:dict,proposed:dict,catalogue:dict)->dict:
 errors=[]
 nv=validate(proposed,previous=previous)
 ...
 if next_catalogue not in {'0.1.0-draft.1','0.1.1-draft.1'}:
