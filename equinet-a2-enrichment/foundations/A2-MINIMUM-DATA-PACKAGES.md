...
- attempt `person.business_email`, published `person.business_phone` and FullEnrich `person.mobile_phone` for selected contacts; at least one verified channel satisfies the minimum when the others are unavailable. Missing mobile alone does not block review.
