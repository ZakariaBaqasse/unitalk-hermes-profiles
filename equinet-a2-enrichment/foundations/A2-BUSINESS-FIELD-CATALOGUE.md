...
The machine-readable catalogue at `foundations/contracts/business/a2-business-field-catalogue-0.3.1.json` is authoritative. It defines 33 business fields, segment priorities, collection boundaries, mappings and the confirmed role/contact policies.
...
- Mobile is actively sought but its absence alone does not block review. Personal email is not requested by default; if returned incidentally by FullEnrich, it is retained separately with provenance and verification status for human review.
