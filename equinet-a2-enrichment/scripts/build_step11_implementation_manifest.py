...
def main():
 ...
 'foundations/decisions/A2-WEBSITE-FIRST-FIRECRAWL-FACEBOOK-20260918.json','foundations/decisions/A2-FULLENRICH-WORK-EMAIL-STATUS-20260921.json','foundations/decisions/A2-FULLENRICH-MISSING-EMAIL-STATUS-20260921.json','foundations/contracts/integrations/a2-official-website-firecrawl-integration-0.1.0.json','foundations/contracts/integrations/a2-apify-facebook-page-contact-integration-0.1.0.json','foundations/contracts/integrations/a2-fullenrich-direct-integration-0.1.4.json','foundations/contracts/sources/a2-source-register-0.3.2.json','foundations/contracts/sources/a2-source-register-0.3.2.csv','foundations/contracts/evidence/a2-evidence-verification-confidence-freshness-policy-0.3.4.json','foundations/contracts/governance/a2-protected-fields-and-conflict-policy-0.3.4.json','foundations/contracts/governance/a2-provider-and-cost-policy-0.5.0.json','foundations/contracts/twenty/a2-twenty-operational-mapping-0.1.3.json','foundations/contracts/runtime/a2-twenty-fullenrich-state-model-0.1.6.json','foundations/contracts/runtime/a2-step11-runtime-policy-0.1.0-rc.1.json','foundations/contracts/integrations/schemas/a2-fullenrich-contact-results.schema.json',
